...
def get_files_and_dirs(config):
    files_and_dirs = {}
    if config.gpulab:
        files_and_dirs['data_dir'] = Path(config.gpulab_data_dir).joinpath('pickles')
        files_and_dirs['transformer_dir'] = Path(config.gpulab_data_dir).joinpath('transformers')
        files_and_dirs['masks_dir'] = Path(config.gpulab_data_dir).joinpath('masks')
    else:
